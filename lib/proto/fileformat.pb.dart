...
class Blob extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Blob', package: const $pb.PackageName(_omitMessageNames ? '' : 'OSMPBF'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, _omitFieldNames ? '' : 'raw', $pb.PbFieldType.OY)
    ..a<$core.int>(2, _omitFieldNames ? '' : 'rawSize', $pb.PbFieldType.O3)
    ..a<$core.List<$core.int>>(3, _omitFieldNames ? '' : 'zlibData', $pb.PbFieldType.OY)
    ..a<$core.List<$core.int>>(4, _omitFieldNames ? '' : 'lzmaData', $pb.PbFieldType.OY)
    ..a<$core.List<$core.int>>(5, _omitFieldNames ? '' : 'OBSOLETEBzip2Data', $pb.PbFieldType.OY, protoName: 'OBSOLETE_bzip2_data')
  ...
  @$pb.TagNumber(2)
  set rawSize($core.int v) { $_setSignedInt32(1, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set zlibData($core.List<$core.int> v) { $_setBytes(2, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set lzmaData($core.List<$core.int> v) { $_setBytes(3, v); }
  @$pb.TagNumber(4)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(5)
  set oBSOLETEBzip2Data($core.List<$core.int> v) { $_setBytes(4, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(5)
...
class BlobHeader extends $pb.GeneratedMessage {
  ...
  BlobHeader._() : super();
  factory BlobHeader.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory BlobHeader.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BlobHeader', package: const $pb.PackageName(_omitMessageNames ? '' : 'OSMPBF'), createEmptyInstance: create)
    ..aQS(1, _omitFieldNames ? '' : 'type')
    ..a<$core.List<$core.int>>(2, _omitFieldNames ? '' : 'indexdata', $pb.PbFieldType.OY)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BlobHeader copyWith(void Function(BlobHeader) updates) => super.copyWith((message) => updates(message as BlobHeader)) as BlobHeader;
  ...
  @$core.pragma('dart2js:noInline')
  static BlobHeader getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<BlobHeader>(create);
  ...
  @$pb.TagNumber(3)
  set datasize($core.int v) { $_setSignedInt32(2, v); }
  @$pb.TagNumber(3)
